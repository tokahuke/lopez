        ...
        S: Serializer,
    {
        match self {
            Self::Success {
                ...
                let mut variant =
                    serializer.serialize_struct_variant("Crawled", 0, "Success", 3)?;
            ...
            Self::BadStatus { status_code } => {
                let mut variant =
                    serializer.serialize_struct_variant("Crawled", 0, "BadStatus", 3)?;
                variant.serialize_field("status_code", &status_code.as_u16())?;
                variant.end()
            }
            Self::Redirect {
                ...
                let mut variant =
                    serializer.serialize_struct_variant("Crawled", 0, "Redirect", 3)?;
                variant.serialize_field("status_code", &status_code.as_u16())?;
            ...
            Self::TimedOut => serializer.serialize_unit_variant("Crawled", 0, "TimedOut"),
        }
    }
}
